      ...
      <div className="relative z-20 pb-4">
        <div className="flex flex-col md:flex-row items-center md:items-end gap-5 md:gap-8">
          ...
          >
            ...
            <div className="w-28 sm:w-36 md:w-44 aspect-2/3 rounded-lg overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.5)] border border-white/10 relative">
              <img
            ...
            {media.vote_average > 0 && (
              <div 
                ...
                title={`User Score: ${Math.round(media.vote_average * 10)}% Liked`}
              >
                ...
                <div className="absolute flex flex-col items-center justify-center text-white">
                  <span className="text-[10px] md:text-xs font-black font-heading tracking-tighter">
                    {Math.round(media.vote_average * 10)}<span className="text-[6px] md:text-[7px] font-bold">%</span>
                  </span>
                </div>
              </div>
            )}
