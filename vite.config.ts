...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['icon_without_bg(v).png'],
      manifest: {
        name: 'ShowLi',
        short_name: 'ShowLi',
        description: 'Plan, discover, and organize your movies and TV shows.',
        theme_color: '#6366f1',
      ...
      workbox: {
        ...
        runtimeCaching: [
          {
            // TMDb API responses — network-first with 24h cache fallback
          ...
          {
            // TMDb image CDN — cache-first (images rarely change)
