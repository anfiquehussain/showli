...
import { DEFAULT_GENRE, DEFAULT_BANNER, AVATAR_PRESETS, BANNER_PRESETS, GENRES } from './constants';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6 relative z-10 custom-scrollbar">
              ...
              <AvatarCustomizer
                photoURL={photoURL}
                showCustomAvatarInput={showCustomAvatarInput}
                isSaving={isSaving}
                setPhotoURL={setPhotoURL}
                setShowCustomAvatarInput={setShowCustomAvatarInput}
              />

              {/* Interactive Banner Customizer */}
              <BannerCustomizer
                bannerURL={bannerURL}
                showCustomBannerInput={showCustomBannerInput}
                isSaving={isSaving}
                setBannerURL={setBannerURL}
                setShowCustomBannerInput={setShowCustomBannerInput}
              />
