  ...
  return (
    <div className="space-y-8 pb-10">
      {(isAuthLoading || isLoading) ? (
        ...
        <>
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-primary/10 via-background to-background border border-white/5 p-8 md:p-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-10">
            {stats.map((stat, i) => (
              <motion.div
                ...
                className="glass-card p-4 rounded-2xl border-white/5 flex items-center gap-4"
              >
